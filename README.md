...
- [func VersionJSON\(w ...io.Writer\)](<#VersionJSON>)
...
<a name="VersionJSON"></a>
## func VersionJSON

```go
func VersionJSON(w ...io.Writer)
```

VersionJSON prints detailed version information in JSON format
...
```go
import "github.com/bruceesmith/echidna/test"
```
